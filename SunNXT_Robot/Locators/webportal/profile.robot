...
${ep_age}                        xpath: /html//form[@id='welcome-profile-form']//button[@role='button']
...
${ep_country}                    css: [role] [class="col-md-6 form-group"]:nth-of-type(1) [type="search"]
${ep_country-selected}           css: [role] [class="col-md-12 form-group"]:nth-of-type(4) [class="col-md-6 form-group"]:nth-of-type(1) span
${ep_state}                      css: [role] [class="col-md-6 form-group"]:nth-of-type(2) [type="search"]
${ep_state-selected}             css: [role] [class="col-md-6 form-group"]:nth-of-type(2) span
...
#switch profile
${switch_profile_pop-up}                    css: #switch-profile .user-profile-item-container
...
${selected_profile}                         css: css: #switch-profile > div > div > div.modal-body > div > a.user-profile-item.selected > div > h4

${add_user_profile}                         css: #switch-profile > div > div > div.modal-body > div > a.add-profile
...
${user_name-input}                          css: .form-inner-wrapper [type]
${btn-add_profile}                          css: #add-profile-form [type="submit"]
