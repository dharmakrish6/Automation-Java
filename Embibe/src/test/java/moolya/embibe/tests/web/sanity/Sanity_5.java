...
public class Sanity_5 extends W_BaseTest {
	...
	public void Sanity_5test(String browser) throws IOException, EncryptedDocumentException, InvalidFormatException, InterruptedException{
